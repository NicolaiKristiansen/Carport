...
public class SVG {
    ...
    private static final String SVG_RECT_TEMPLATE = "<rect x=\"%d\" y=\"%f\" height=\"%f\" width=\"%f\" style=\"%s\"/>";
    ...
    public void addRectangle(double x, int y, double height, double width, String style){
